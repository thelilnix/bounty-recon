...
report() {
    ...
    for subdir in $(/usr/bin/ls -Al $report_path/$1/scans/dirsearch/*.txt | awk -F':[0-9]* ' '/:/{print $2}' | rev | cut -d"/" -f 1 | rev | sed "s/.txt//g");do
        echo "<pre style='color:white;'>$subdir <a href='../scans/dirsearch/$subdir.txt' class='btn btn-info'>Let's go</a></pre>" >> $report_path/$1/report/index.html
    done
    ...
    # dalfox.html
    echo "<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1'><link href='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css' rel='stylesheet' integrity='sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl' crossorigin='anonymous'><title>Report Dalfox - $1</title></head><body><style>body{background-color:#2c3e50}</style><nav class='navbar fixed-top navbar-expand-lg navbar-dark bg-dark'><div class='container-fluid'> <a class='navbar-brand'>Recon!</a> <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarNavAltMarkup' aria-controls='navbarNavAltMarkup' aria-expanded='false' aria-label='Toggle navigation'> <span class='navbar-toggler-icon'></span> </button><div class='collapse navbar-collapse' id='navbarNavAltMarkup'><div class='navbar-nav'> <a class='nav-link' href='index.html'>Subdomains</a> <a class='nav-link' href='../scans/Aquatone/aquatone_report.html' target='_blank'>Aquatone</a> <a class='nav-link' href='wayback.html'>WayBackMachine</a> <a class='nav-link' href='gospider.html'>GoSpider</a> <a class='nav-link' href='dns.html'>DNS</a> <a class='nav-link active' aria-current='page'>Dalfox</a> <a class='nav-link' href='../scans/JS/report.html' target='_blank'>JSFScan</a> <a class='nav-link' href='nmap.html'>NMAP</a><a class='nav-link' href='urls.html'>URLs</a></div></div></div> </nav> <br/> <br/> <br/> <br/><h2 class='text-white'>Dalfox Output (For XSS)</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/scans/XSS_check/dalfox.txt 2>/dev/null) </pre> <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js' integrity='sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0' crossorigin='anonymous'></script> </body></html>" >> $report_path/$1/report/dalfox.html
    # wayback.html
    echo "<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1'><link href='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css' rel='stylesheet' integrity='sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl' crossorigin='anonymous'><title>Report WayBackURLS - $1</title></head><body><style>body{background-color:#2c3e50}</style><nav class='navbar fixed-top navbar-expand-lg navbar-dark bg-dark'><div class='container-fluid'> <a class='navbar-brand'>Recon!</a> <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarNavAltMarkup' aria-controls='navbarNavAltMarkup' aria-expanded='false' aria-label='Toggle navigation'> <span class='navbar-toggler-icon'></span> </button><div class='collapse navbar-collapse' id='navbarNavAltMarkup'><div class='navbar-nav'> <a class='nav-link' href='index.html'>Subdomains</a> <a class='nav-link' href='../scans/Aquatone/aquatone_report.html' target='_blank'>Aquatone</a> <a class='nav-link active' aria-current='page'>WayBackMachine</a> <a class='nav-link' href='gospider.html'>GoSpider</a> <a class='nav-link' href='dns.html'>DNS</a> <a class='nav-link' href='dalfox.html'>Dalfox</a> <a class='nav-link' href='../scans/JS/report.html' target='_blank'>JSFScan</a> <a class='nav-link' href='nmap.html'>NMAP</a><a class='nav-link' href='urls.html'>URLs</a></div></div></div> </nav> <br/> <br/> <br/> <br/><h2 class='text-white'>Total Output</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/wayback/waybackurls.txt 2>/dev/null) </pre><h2 class='text-white'>paramlist.txt</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/wayback/paramlist.txt 2>/dev/null) </pre><h2 class='text-white'>jsurls.txt</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/wayback/jsurls.txt 2>/dev/null) </pre><h2 class='text-white'>phpurls.txt</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/wayback/phpurls.txt 2>/dev/null) </pre><h2 class='text-white'>aspxurls.txt</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/wayback/aspxurls.txt 2>/dev/null) </pre><h2 class='text-white'>jspurls.txt</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/wayback/jspurls.txt 2>/dev/null) </pre> <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js' integrity='sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0' crossorigin='anonymous'></script> </body></html>" >> $report_path/$1/report/wayback.html
    # urls.html
    echo "<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1'><link href='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css' rel='stylesheet' integrity='sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl' crossorigin='anonymous'><title>Report WayBackURLS - $1</title></head><body><style>body{background-color:#2c3e50}</style><nav class='navbar fixed-top navbar-expand-lg navbar-dark bg-dark'><div class='container-fluid'> <a class='navbar-brand'>Recon!</a> <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarNavAltMarkup' aria-controls='navbarNavAltMarkup' aria-expanded='false' aria-label='Toggle navigation'> <span class='navbar-toggler-icon'></span> </button><div class='collapse navbar-collapse' id='navbarNavAltMarkup'><div class='navbar-nav'> <a class='nav-link' href='index.html'>Subdomains</a> <a class='nav-link' href='../scans/Aquatone/aquatone_report.html' target='_blank'>Aquatone</a> <a class='nav-link' href='wayback.html'>WayBackMachine</a> <a class='nav-link' href='gospider.html'>GoSpider</a> <a class='nav-link' href='dns.html'>DNS</a> <a class='nav-link' href='dalfox.html'>Dalfox</a> <a class='nav-link' href='../scans/JS/report.html' target='_blank'>JSFScan</a> <a class='nav-link' href='nmap.html'>NMAP</a> <a class='nav-link active' aria-current='page'>URLs</a></div></div></div> </nav> <br/> <br/> <br/> <br/><h2 class='text-white'>Live URLs</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/urls.txt 2>/dev/null) </pre> <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js' integrity='sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0' crossorigin='anonymous'></script> </body></html>" >> $report_path/$1/report/urls.html
    # gospider.html
    echo "<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1'><link href='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css' rel='stylesheet' integrity='sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl' crossorigin='anonymous'><title>Report GoSpider - $1</title></head><body><style>body{background-color:#2c3e50}</style><nav class='navbar fixed-top navbar-expand-lg navbar-dark bg-dark'><div class='container-fluid'> <a class='navbar-brand'>Recon!</a> <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarNavAltMarkup' aria-controls='navbarNavAltMarkup' aria-expanded='false' aria-label='Toggle navigation'> <span class='navbar-toggler-icon'></span> </button><div class='collapse navbar-collapse' id='navbarNavAltMarkup'><div class='navbar-nav'> <a class='nav-link' href='index.html'>Subdomains</a> <a class='nav-link' href='../scans/Aquatone/aquatone_report.html' target='_blank'>Aquatone</a> <a class='nav-link' href='wayback.html'>WayBackMachine</a> <a class='nav-link active' aria-current='page'>GoSpider</a> <a class='nav-link' href='dns.html'>DNS</a> <a class='nav-link' href='dalfox.html'>Dalfox</a> <a class='nav-link' href='../scans/JS/report.html' target='_blank'>JSFScan</a> <a class='nav-link' href='nmap.html'>NMAP</a> <a class='nav-link' href='urls.html'>URLs</a></div></div></div> </nav> <br/> <br/> <br/> <br/><h2 class='text-white'>GoSpider Output</h2><hr style='color: white;'/><pre class='text-white'> $(cat $report_path/$1/gospider/* 2>/dev/null) </pre> <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js' integrity='sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0' crossorigin='anonymous'></script> </body></html>" >> $report_path/$1/report/gospider.html
